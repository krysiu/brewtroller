...
#define BTPD_MASH_TEMP 0x21 // BTPD_MASH_TEMP: Displays Mash temp and setpoint on specified channel
#define BTPD_KETTLE_TEMP 0x22 // BTPD_KETTLE_TEMP: Displays Kettle temp and setpoint on specified channel
#define BTPD_H2O_TEMPS 0x23 // BTPD_H2O_TEMPS: Displays H2O In and H2O Out temps on specified channels
