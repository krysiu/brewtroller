...
/*
  ...
  Modified 27 August 2010 by Tom Harkaway
*/

/////////////////////////////////////////////////////////////////////
//
//	1. Just get it working with comments
//	2. Change int indexes to chars
//	3. Change % w/size to & w/mask
//	4. Add Transmit Buffer
//
/////////////////////////////////////////////////////////////////////
...
// serial 0 ring buffers for everybody
//
ring_bufferRx rx_buffer = { { 0 }, 0, 0 };
ring_bufferTx tx_buffer = { { 0 }, 0, 0 };

// serial 1 ring buffer for 644 or 1280
//
//#if defined(__AVR_ATmega644P__) || defined(__AVR_ATmega1284__) || defined(__AVR_ATmega1280__)
ring_bufferRx rx_buffer1 = { { 0 }, 0, 0 };
ring_bufferTx tx_buffer1 = { { 0 }, 0, 0 };
//#endif\

// serial 2 & 3 ring buffers for 1280
//
...
//#if defined(__AVR_ATmega644P__) || defined(__AVR_ATmega1284P__) || defined(__AVR_ATmega1280__)
...
{
	// if the head == tail, buffer is empty
...
//	&UBRRH	- USART Baud Rate Reguster High		0xC5	0xCD	0xD5	0x135
...
//	RXC		- bit7	RxD Recieve Complete (UCSRA bit 7)
