...
#define BT_HWPROFILE
  ...
  #define VALVE1_PIN 6  //Valve 1
  #define VALVE2_PIN 7  //Valve 2
  #define VALVE3_PIN 25 //Valve 3
  #define VALVE4_PIN 26 //Valve 4
  #define VALVE5_PIN 10 //Valve 5
  #define VALVE6_PIN 12 //Valve 6
  #define VALVE7_PIN 13 //Valve 7
  #define VALVE8_PIN 14 //Valve 8
  #define VALVE9_PIN 24 //Valve 9
  #define VALVEA_PIN 18 //Valve A
  #define VALVEB_PIN 16 //Valve B
  #define VALVEC_PIN 0  //HLT
  #define VALVED_PIN 1  //Mash
  #define VALVEE_PIN 3  //Kettle
  #define VALVEF_PIN 6  //Steam
  #define VALVEG_PIN 15 //Buzzer
